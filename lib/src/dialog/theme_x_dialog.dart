...
class ThemeXDialog extends StatefulWidget {
  const ThemeXDialog({
    Key? key,
  }) : super(key: key);

  @override
  State<ThemeXDialog> createState() => _ThemeXDialogState();
}

class _ThemeXDialogState extends State<ThemeXDialog> {
